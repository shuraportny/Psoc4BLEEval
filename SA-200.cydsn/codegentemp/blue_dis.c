...
{
    0x0039u,    /* Handle of the DIS service */
    {
        0x003Bu, /* Handle of the Manufacturer Name String characteristic */ 
        0x003Du, /* Handle of the Model Number String characteristic */ 
        0x003Fu, /* Handle of the Serial Number String characteristic */ 
        0x0041u, /* Handle of the Hardware Revision String characteristic */ 
        0x0043u, /* Handle of the Firmware Revision String characteristic */ 
        0x0045u, /* Handle of the Software Revision String characteristic */ 
        0x0047u, /* Handle of the System ID characteristic */ 
        0x0049u, /* Handle of the IEEE 11073-20601 Regulatory Certification Data List characteristic */ 
        0x004Bu, /* Handle of the PnP ID characteristic */ 
    },
};
